import img1 from "../../../assets/hammer/GBN220TL-L-C.png";
import img2 from "../../../assets/hammer/GBN220TL-L.png";

export default function GBN220TL() {
    return (
        <div className="mt-20 md:mt-24">
                ...
                <div className="md:basis-1/2 pl-8 md:pt-16 text-white flex flex-col justify-center">
                    <h1 className="text-3xl font-bold">GBN220TL</h1>
