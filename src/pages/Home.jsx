            ...
            >
                <SwiperSlide className="bg-Black flex items-center justify-center gap-4 flex-wrap md:flex-nowrap  px-4 border-y-8 border-y-Amber h-[calc(100vh-80px)] static z-0 md:h-[calc(100vh-95px)]">
                    <div className="flex flex-col items-start gap-4 px-4 pt-12 md:pl-12 md:pr-0 md:pt-0">
                        <Fade duration={2000} delay={100}>
                            <h1 className="text-Amber text-2xl md:text-3xl font-extrabold ">
                                Notre Engagement : Innovation & Performance
                            </h1>
                        </Fade>
                        <Fade duration={2000} delay={400}>
                            <div className="text-base md:text-lg text-white">
                                Explorez notre gamme de brise-roches
                                hydrauliques de pointe pour une démolition
                                efficace et précise, avec un engagement vers
                                l&apos;innovation, la performance, et la
                                fiabilité.
                            </div>
                        </Fade>
                        <Fade duration={2000} delay={700} className="self-center md:self-auto">
                            <Link
                                to={"/about"}
                ...
                <SwiperSlide className="bg-Black flex items-center justify-center gap-4 flex-wrap md:flex-nowrap  px-4 border-y-8 border-y-Amber h-[calc(100vh-80px)] static z-0 md:h-[calc(100vh-95px)]">
                    ...
                    <div className="flex flex-col items-start gap-4 px-4 pt-12 md:pl-12 md:px-0 md:pt-0 md:pr-12 md:w-5/6 xl:w-5/6 order-first md:order-last">
                        ...
                        <Fade duration={2000} delay={400}>
                            <div className="text-base md:text-lg text-white">
                                Nous sommes fiers de notre présence mondiale et
                                de notre expérience internationale dans
                                l&apos;industrie des brise-roches hydrauliques.
                                Nos solutions ont été utilisées avec succès sur
                                des chantiers de grande envergure à travers le
                                monde, témoignant de notre engagement envers
                                l&apos;excellence dans chaque projet. Découvrez
                                comment notre expertise peut répondre à vos
                                besoins.
                            </div>
                        </Fade>
                        <Fade duration={2000} delay={700} className="self-center md:self-auto">
