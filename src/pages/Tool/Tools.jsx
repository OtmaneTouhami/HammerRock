    ...
    return (
        <div className="mt-20 md:mt-24">
            <div className="px-6 md:px-8 pt-12 pb-4 border-y-8 border-y-Amber">
                <h1 className="text-3xl md:text-4xl font-bold mb-6">Outil</h1>
                ...
                <p className="md:w-5/6 leading-relaxed md:text-lg mb-6 tracking-wider text-justify">
                    <span className="font-bold text-lg md:text-xl">HRK</span>{" "}
                    fabrique la plus large gamme d&apos;outils de démolition de
                    haute qualité en Corée, compatibles avec la plupart des
                    marteaux hydrauliques lourds. Les ingénieurs de{" "}
                    <span className="font-bold text-lg md:text-xl">HRK</span>{" "}
                    font de leur mieux dans le processus de fabrication, le
                    contrôle de la qualité et la recherche et développement pour
                    produire les outils de démolition de la plus haute qualité
                    au monde.
                </p>
                ...
                <div className="px-4 py-12 space-y-2 text-justify tracking-wide">
                    <div className="flex justify-between gap-4">
                        ...
                        <p className="basis-full">
                            Les outils <span className="font-bold">HRK</span>{" "}
                            sont garantis contre les défauts de matériau et de
                            fabrication.
                        </p>
                    </div>
                    <div className="flex justify-between gap-4">
                        ...
                        <p className="basis-full">
                            ...
                            concerne toute réclamation de garantie se limite au
                            remplacement des outils et ne s&apos;étend pas à
                            d&apos;autres dépenses engagées ni aux dommages
                            consécutifs.
                        </p>
                    </div>
                </div>
                ...
                <p className="leading-relaxed md:text-lg mb-6 tracking-wider mt-3 text-justify font-semibold">
                    Le but de ce guide est de vous permettre de montrer à votre
                    client l&apos;application correcte des outils{" "}
                    <span className="font-bold text-lg md:text-xl">HRK</span> et
                    de vous aider à résoudre immédiatement les plaintes
                    lorsqu&apos;elles surviennent. Lorsqu&apos;un outil semble
                    ne pas avoir une durée de vie satisfaisante, une inspection
                    visuelle résout souvent rapidement la cause et permet
                    d&apos;économiser sur les coûts de transport et de prévenir
                    la frustration lorsque la garantie est refusée.
                </p>
                ...
                <div className="leading-relaxed md:text-lg mb-6 tracking-wider mt-3 text-justify font-semibold">
                    <p>
                        Lorsque le piston du marteau (briseur) frappe le sommet
                        de l&apos;outil de démolition, il envoie une onde de
                        contrainte compressive jusqu&apos;à l&apos;extrémité de
                        travail de l&apos;outil.
                    </p>
                    <p className="mt-2">
                        Tant que l&apos;outil de démolition est en contact avec
                        la roche ou le béton à casser, c&apos;est cette onde de
                        contrainte compressive qui fracture la roche.
                        Immédiatement après l&apos;onde de contrainte
                        compressive, une onde de contrainte de traction se forme
                        lorsque le piston du marteau se soulève du sommet de
                        l&apos;outil de démolition !
                    </p>
                    <p className="mt-10">
                        Ce cycle de contraintes compressives et de contraintes
                        de traction se répète pour chaque coup de marteau.
                        Évidemment, tout ce qui perturbe la &quot;force&quot; de
                        l&apos;onde de contrainte compressive pendant le
                        service, par exemple le &quot;jeu libre&quot; ou la
                        flexion de l&apos;outil de démolition en raison de la
                        levier, entraînera une perte d&apos;efficacité du
                        briseur pouvant atteindre 80 % et un risque de
                        défaillance par fatigue de l&apos;outil lui-même.
                    </p>
                </div>
                ...
                >
                        ...
                        <div>
                            ...
                            <div className="py-4 md:p-8 flex flex-col md:flex-row items-center justify-center">
                                ...
                                <div className="basis-1/2 md:px-12 space-y-4">
                                    ...
                                    <p className="text-lg">
                                        La principale cause du stress de fatigue
                                        accru dans un outil de démolition est
                                        toute forme de pression latérale pendant
                                        le service qui crée de la flexion.
                                        Ainsi, utiliser l&apos;outil comme
                                        levier, utiliser le mauvais angle
                                        d&apos;attaque ou essayer de briser le
                                        sol en utilisant la traction de la
                                        machine sont tous préjudiciables à la
                                        durée de vie de l&apos;outil de
                            ...
                            <div className="py-4 md:p-8 flex flex-col md:flex-row items-center justify-center">
                                <div className="order-2 md:order-1 basis-1/2 md:px-12 space-y-4">
                                    ...
                                    <p className="text-lg">
                                        D&apos;autres causes de
                                        l&apos;augmentation du stress de fatigue
                                        dans un outil de démolition incluent :{" "}
                                        <br />{" "}
                                        <span className="font-bold">
                                            A) Jeu libre
                                        </span>
                                        <br /> En général, il s&apos;agit de
                                        toute situation où le piston du marteau
                                        frappe le sommet de l&apos;outil de
                                        démolition, mais l&apos;extrémité de
                                        travail n&apos;est pas en contact
                                        approprié avec la roche ou le béton à
                                        casser. Cela inclut les situations où
                                        l&apos;outil glisse hors du travail et
                                        également lorsque la percée de dalles de
                                        béton minces ou de gros rochers se
                                        produit.
                                    </p>
                                </div>
                            ...
                            <div className="md:px-20 space-y-2">
                                <p className="text-lg">
                                    ...
                                    <br />
                                    Les températures basses rendent un outil de
                                    démolition plus susceptible de subir une
                                    défaillance par fatigue. Les outils doivent
                                    être réchauffés avant utilisation.
                                </p>
                                <p className="text-lg">
                                    <span className="font-bold">
                                        C) Dommages mécaniques et thermiques
                                    </span>
                                    <br /> Toute forme de dommage à la surface
                                    d&apos;un outil de démolition le rend plus
                                    susceptible de subir une défaillance par
                                    fatigue. <br />
                                    Ainsi, il convient de prendre toutes les
                                    précautions nécessaires pour éviter les
                                    entailles accidentelles ou le soudage par
                                    contact (« galling » ou « pick-up ») en
                                    raison du contact entre l&apos;outil et la
                                    douille de mandrin par manque de
                                ...
                                <p className="text-lg">
                                    ...
                                    <br />
                                    Il faut veiller à éviter tout contact métal
                                    sur métal qui, suite au « galling » ou au «
                                    pick-up », pourrait causer des marques de
                                    dommage profondes, lesquelles, à leur tour,
                                    conduisent à la formation de fissures par
                                    fatigue et à la défaillance ultérieure de
                                    l&apos;outil de démolition. Assurez-vous que
                                    la tige de l&apos;outil de démolition est
                                    bien lubrifiée avant de la fixer dans la
                                    machine. La graisse au bisulfure de
                                    molybdène est recommandée pour cette
                                    application, à des intervalles de trois
                                    heures ou selon les instructions du
                                    fabricant.
                                </p>
                                <p className="text-lg">
                                    <span className="font-bold">
                                    ...
                                    susceptible de subir une défaillance par
                                    fatigue, il convient donc de bien graisser
                                    les outils et de les protéger des
                                    intempéries lorsqu&apos;ils ne sont pas
                                    utilisés.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="py-4 md:p-8 flex flex-col md:flex-row items-center justify-center">
                                ...
                                <div className="basis-1/2 md:px-12 space-y-4">
                                    ...
                                    <p className="text-lg">
                                        ...
                                        l&apos;outil de démolition se produira
                                        généralement à environ 4&quot; (100 mm)
                                        de part et d&apos;autre de la face avant
                                        du mandrin.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="py-4 md:p-8 flex flex-col md:flex-row items-center justify-center">
                                <div className="order-2 md:order-1 basis-1/2 md:px-12 space-y-4">
                                    ...
                                    <p className="text-lg">
                                        Une autre zone de défaillance légèrement
                                        moins courante peut se situer à environ
                                        8&quot; (200 mm) de l&apos;extrémité de
                                        travail, en fonction de la nature de
                                        l&apos;utilisation.
                                        <br /> La surface de rupture elle-même
                                        présentera généralement une zone polie
                                        semi-circulaire, le reste ayant une
                                        apparence plus rugueuse.
                                    </p>
                                </div>
                                <figure className="basis-1/2 order-1 md:order-2">
                                    <img src={img22} />
                            ...
                            <div className="py-4 space-y-2 border-t-2 border-dashed border-t-Amber">
                                <p className="text-lg">
                                    ...
                                    a damage mark or otherstress raisers on the
                                    outside of the demolition tool and spreads
                                    inwards. The fatigue area slowly widens
                                    until the stresses being applied to the
                                    demolition tool cause sudden failure of the
                                    remaining section. Generally, the size of
                                    the fatigue area indicates the level of
                                    stress applied to the tool, i.e. the smaller
                                    the fatigue area, the higher the
                                    stresslevel, although it must be borne in
                                    mind that once initiation of a fatigue crack
                                    hastaken place, it requires a lower stress
                    ...
                    <SwiperSlide className="md:px-6 py-8">
                        <div>
                            <h2 className="text-Amber text-xl md:text-2xl font-bold  tracking-wider">
                                Défaillances typiques (guide des réclamations de
                                garantie)
                            </h2>
                            <div className="py-4 md:p-8 flex flex-col md:flex-row items-center justify-center">
                                <figure className="basis-1/2">
                            ...
                            <div className="py-4 md:p-8 flex flex-col md:flex-row items-center justify-center">
                                <div className="order-2 md:order-1 basis-1/2 md:px-12 space-y-4">
                                    ...
                                    <p className="text-lg">
                                        Fracture typique due à un stress élevé,
